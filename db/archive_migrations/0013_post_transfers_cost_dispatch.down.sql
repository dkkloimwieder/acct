-- Restore W1 body (no cost-method dispatch). Verbatim copy of 0012's
-- function body — Postgres has no in-place "remove these statements
-- from a PL/pgSQL body"; the only way to undo a CREATE OR REPLACE is
-- another CREATE OR REPLACE.
