-- Down: restore mig 0028 body of post_standard_cost_roll (cross-class
-- qty divisor; acct-du2.11 unfixed). Restore verbatim from
-- 0028_post_standard_cost_roll.up.sql.
