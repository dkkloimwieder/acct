-- acct-wig — best-effort revert. Per project convention down is a
-- safety net, not a full restore: this restores the 0062 bodies of
-- post_wo_start, post_op_move, post_wo_complete (standard-only WO
-- parents). On a fresh DB, re-applying 0063 puts wac_perpetual back.
