-- acct-v5r6 / acct-7t4.2 down: restore mig 0070 post_wo_start (no
-- bom_by_products → wo_by_products snapshot block) and drop the
-- wo_by_products table + immutability trigger.

DROP TABLE IF EXISTS wo_by_products;
DROP FUNCTION IF EXISTS wo_by_products_planned_qty_immutable();

-- Restore mig 0070 post_wo_start verbatim.
