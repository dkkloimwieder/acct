-- acct-a41h / acct-7t4.6 down: restore mig 0099 post_wo_complete
-- (no yield variance leg). variance_yield_byproduct enum value left
-- in place per project convention.
