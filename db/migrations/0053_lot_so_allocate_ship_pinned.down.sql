-- Revert post_so_allocate to mig 0018 body (no W1 pinned-lot
-- residual validation) and post_so_ship to mig 0050 body (no W2
-- reservation-pin lookup in the lot_fifo branch).
...
-- post_so_ship reverts to mig 0050 verbatim.
