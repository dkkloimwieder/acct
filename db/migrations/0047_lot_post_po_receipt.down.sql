-- Down for L1: restore mig 0034's post_po_receipt body verbatim
-- (no lot metadata forwarding, no audit-stamp UPDATE) and drop the
-- po_receipt_lines.lot_id audit column.
...
DROP INDEX IF EXISTS po_receipt_lines_lot;
ALTER TABLE po_receipt_lines DROP COLUMN IF EXISTS lot_id;
