-- Revert acct-0ig: restore migration 0013's post_transfers (caller-supplied
-- amount + cost-method gate, no compute helper).

DROP FUNCTION IF EXISTS _post_transfers_compute_amount(JSONB, accounts, accounts, cost_method, INT);
