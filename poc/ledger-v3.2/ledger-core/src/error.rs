...
pub enum LedgerError {
    /// Depletion would drive aggregate qty below zero on a strict-method pool.
    /// WAC/STD/specific keep their synchronous qty gate (design-v3.2 §3); the
    /// negative-allowed flagged posture (design-v3.1 §16) applies to FIFO/LIFO
    /// appends, which never dispatch here.
