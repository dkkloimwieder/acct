-- design-v3.1 §2.1 — enums (the v2 schema base design-v3.2 §2 carries forward).
-- The recalc engine's cost_adjustment labels are added in 0008 (recalc-d §2),
-- keeping the recalc-d schema surface reviewable as one unit.
