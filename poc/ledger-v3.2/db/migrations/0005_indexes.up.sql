-- design-v3.1 §2.2 / §2.3 — indexes (collected here; tables created in
-- 0002-0004). The per-pool trx_line composite lands in 0007 alongside the
-- posted_at denormalization it indexes (recalc-d D1).
